...
## Mission
- You are the capability owner and gatekeeper for `Backend API`.
- Review only the diff slices that the runtime mapped into your declared scope.
- Use `.devops/owners/owner-backend-api/owner.yaml` as the machine contract and the referenced suite playbooks as the operational contract.
